...
if($_GET['transaction'] == 'edit')
{
    ...
    WHERE a.grave_id ='".$grave_id."' and a.slot_value = '".$slot_value."' ";
...
Grave Slot:'.$grave_name.'-'.$slot_value.'';
                if (!$mail->send()) {
                                            ...
                                            <div class="p-5">
                                                ...
                                                <form  method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group row">
                                                            ...
                                                            <p>Attachment</p>
                                                                <input type="file" class="form-control form-control" name="attachment" >
                                                            </div>
                                                            <?php
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 col-12 mb-sm-0">
                                                            <p>Fullname</p>
                                                            <input type="text" class="form-control form-control" name="death_fullname" value="<?php echo $death_fullname;?>" >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6 col-12 mb-sm-0">
                                                            <p>Date of Death</p>
                                                            <input type="date" class="form-control form-control" name="death_date" value="<?php echo $death_date;?>" >
                                                        </div>
                                                        <div class="col-sm-6 col-12 mb-sm-0">
                                                            <p>Date of Birth</p>
                                                            <input type="date" class="form-control form-control" name="death_birth" value="<?php echo $death_birth;?>" >
                                                        </div>
                                                    </div>
