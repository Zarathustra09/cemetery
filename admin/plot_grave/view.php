                            ...
                            <?php for ($i = 1; $i <= $table_row; $i++) { ?>
                                <tr>
                                    <?php for ($j = 1; $j <= $table_column; $j++) { 
                                        ...
                                        $button = '<td>
                                            <button href="register.php?slot_value='.$slot.'&grave_id='.$_GET['id'].'&transaction=add" class="btn btn-info button-slot" name="'.$slot.'"><i class="fas fa-check"></i></button>
                                        </td>'; 
                                        ...
                                        while ($row1 = $result1->fetch_assoc()) {
                                            if($row1['status'] == 'NOT AVAILABLE'){
                                                $button = '<td>
                                                <button href="register.php?slot_value='.$slot.'&grave_id='.$_GET['id'].'&transaction=edit" class="btn btn-danger button-slot" name="'.$slot.'"><i class="fas fa-times"></i></button>
                                            </td>';
                                            }
                                            else if($row1['status'] == 'RESERVED'){
                                                $button = '<td>
                                                <button href="register.php?slot_value='.$slot.'&grave_id='.$_GET['id'].'&transaction=edit"  class="btn btn-warning button-slot" name="'.$slot.'"><i class="fas fa-lock"></i></button>
                                            </td>';
                                            }
                                            else if($row1['status'] == 'TAKEN'){
                                                $button = '<td>
                                                <button href="register.php?slot_value='.$slot.'&grave_id='.$_GET['id'].'&transaction=edit"  class="btn btn-success button-slot" name="'.$slot.'"><i class="fas fa-user"></i></button>
                                            </td>';
                                            }
                                        }
                                    ?>
